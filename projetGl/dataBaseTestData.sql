...
/* ajout des projets */
INSERT INTO projetGL_projet(nom, description, uniteTemps, avancement, client, responsable, etat) VALUES("Bouquet de fleur", "Creation d’un bouquet de fleurs", 1, 35, 1, 3, 1);
    /* ajout des taches */
    ...
    INSERT INTO projetGL_tache(nom, description, dateDebut, dateFinTot, dateFinTard, charge, avancement, tempsPasse, tempsRestant, detruitALaCompletion, niveau, tacheMere, predecesseur, projet, responsable, contact, etat)
    VALUES("Preparer le colis", "il faut emballer le bouquet", ADDDATE(now(), 15), ADDDATE(now(), 20), ADDDATE(now(), 22), 5, 0, 0, 5, true, 0, null, null, 1, 4, 8, 1);
    INSERT INTO projetGL_tache(nom, description, dateDebut, dateFinTot, dateFinTard, charge, avancement, tempsPasse, tempsRestant, detruitALaCompletion, niveau, tacheMere, predecesseur, projet, responsable, contact, etat)
    VALUES("Envoyer le colis", "il faut remettre le colis a la poste", ADDDATE(now(), 15), ADDDATE(now(), 20), ADDDATE(now(), 22), 5, 0, 0, 5, true, 1, 4, null, 1, 4, 8, 1);